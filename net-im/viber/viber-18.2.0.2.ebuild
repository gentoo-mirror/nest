...
src_install() {
	...
	fperms -R +x /opt/viber/Viber \
		/opt/viber/libexec/QtWebEngineProcess \
		/opt/viber/plugins/{generic,imageformats,platforminputcontexts,platforms,printsupport,sqldrivers,tls,wayland-decoration-client,wayland-graphics-integration-client,wayland-graphics-integration-server,wayland-shell-integration,xcbglintegrations}/ \
